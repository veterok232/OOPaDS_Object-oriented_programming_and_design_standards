...
namespace TrapeziumPlugin
{
    ...
    public class Trapezium2 : Shape
    {
        ...
        public Trapezium2(float width = 1) : this(Color.Black, Color.White, width) { }

        public Trapezium2(Color penColor, Color fillColor, float width = 1)
        {
            aMainPenColor = penColor;
            aMainPenWidth = width;
            aMainFillColor = fillColor;
        ...
        public override void Draw(Graphics g)
        {
            ...
            // Массив точек
            var trapezium_points = new Point[] { new Point(p1.X + (p2.X - p1.X) / 5, p1.Y),
                                           new Point(p2.X - (p2.X - p1.X) / 5, p1.Y),
                                           p2,
                                           new Point(p1.X, p2.Y) };
        ...
        public override Shape Clone()
        {
            return (Trapezium2)this.MemberwiseClone();
        }
    }
}
